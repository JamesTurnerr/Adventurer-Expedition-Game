...
public enum RegularItem implements Item {
     ...
     */
    RegularItem(String name, String description, int modifier, int cost)
    {
        this.name = name;
        this.cost = cost;
     ...
     */
    public static RegularItem getRandomItem()
    {
        RegularItem[] regularItems = values();
        Random random = new Random();
        return regularItems[random.nextInt(regularItems.length)];
    }
}
