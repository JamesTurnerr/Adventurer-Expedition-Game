...
public class GuiService {
    ...
    public void updateTopLabels(Label gold, Label expedition, Label remaining) {
        gold.setText(String.valueOf(UserData.getGold()));
        expedition.setText(String.valueOf(UserData.getCurrentExpeditionNumber()));
        remaining.setText(String.valueOf(UserData.getExpeditionsRemaining()));
    }

    public void populateAdventurerSlots(List<Button> slots) {
        List<Adventurer> party = UserData.getMainParty();
